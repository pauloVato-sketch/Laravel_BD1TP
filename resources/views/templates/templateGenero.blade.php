        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="{{ route('genero.index') }}">Lista de Generos <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('genero.create') }}">Inserir Genero</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('genero.delete') }}">Remover Genero</a>
                </li>       
            </ul>
        </div>
    </nav>
