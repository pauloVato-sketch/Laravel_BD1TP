        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="{{ route('ator.index') }}">Lista de atores <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('ator.create') }}">Inserir Ator</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('ator.delete') }}">Remover Ator</a>
                </li>       
            </ul>
        </div>
    </nav>
