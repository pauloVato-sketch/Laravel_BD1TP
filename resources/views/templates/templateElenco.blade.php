        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="{{ route('elenco.index') }}">Lista de Elencos <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('elenco.create') }}">Inserir Elenco</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('elenco.delete') }}">Remover Elenco</a>
                </li>       
            </ul>
        </div>
    </nav>
