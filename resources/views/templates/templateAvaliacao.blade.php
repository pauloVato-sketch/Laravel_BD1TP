        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item active">
                    <a class="nav-link" href="{{ route('avaliacao.index') }}">Lista de Avaliações <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('avaliacao.create') }}">Inserir Avaliação</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('avaliacao.delete') }}">Remover Avaliação</a>
                </li>       
            </ul>
        </div>
    </nav>
